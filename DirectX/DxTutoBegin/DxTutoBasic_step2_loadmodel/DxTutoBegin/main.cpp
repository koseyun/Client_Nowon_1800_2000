/*
    ...
    1. CMtlTexture
    <--Material재질 개념을 다루는 클래스(셰이더를 관리하는 클래스이다)

        Material : How to Shading 어떻게 셰이딩(최종색상결정)을 해야 하는지에 대한 데이터와 방법을 다루는 개념

    2. CTextureApi
    <-- 텍스처(3D 그래픽스에서 다루는 이미지 데이터 개념)를 다루는 클래스        
*/
...
public:
    ...
    virtual void OnCreate() override
    {
        ...
        */
        mpMesh = new CMesh();
        mpMesh->Create(this->GetD3DDevice());
    ...
    virtual void OnUpdate(float tDeltaTime) override
    {
        ...
        XMFLOAT4 tLightColor = XMFLOAT4(0.0f, 1.0f, 1.0f, 1.0f); // 빛 색상, 붉은색으로 가정
        // 빨간색(1.0f, 0.0f, 0.0f, 1.0f) 연두색(0.0f, 1.0f, 0.0f, 1.0f) 파란색(0.0f, 0.0f, 1.0f, 1.0f)
        // 노란색(1.0f, 1.0f, 0.0f, 1.0f) 핑크색(1.0f, 0.0f, 1.0f, 1.0f) 민트색
