...
public:
	...
	bool AddAniSeq(const string& tStrKey, float tTimeInterval, int tTotalFramesCount, ANI_PO tPlayOption = ANI_PO::LOOP, ANI_SO tSpriteOption = ANI_SO::FRAME_FILE, int tRow = 1, int tCol = 1);
