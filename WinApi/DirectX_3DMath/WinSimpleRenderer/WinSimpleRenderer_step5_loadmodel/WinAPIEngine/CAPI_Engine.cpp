...
void CAPI_Engine::FillTriangle(int x_0, int y_0, int x_1, int y_1, int x_2, int y_2, ApiPixel tPixel)
{
    float tR = 1.0f * (tPixel.r / 255.0f);
    float tG = 1.0f * (tPixel.g / 255.0f);
    float tB = 1.0f * (tPixel.b / 255.0f);
